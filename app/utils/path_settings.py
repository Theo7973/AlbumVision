...
class PathSettings:
    """Manages application settings including output path configuration"""
    ...
    def debug_info(self):
        """Return debug information about current settings"""
        return {
            "settings_file": self.settings_file,
            "settings_exist": os.path.exists(self.settings_file),
